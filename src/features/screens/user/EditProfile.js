...
class EditProfile extends React.Component {
    state={
        skills:['Art Direction','Story Boarding','Management','Sound Design','Management','Story Board'],
        data:[{
            title:'TITLE 1',
            name:'Project 1',
  ...
  render() {
    ...
    <ActivityIndicator size="small" color="#fff" style={{paddingTop:10}}/>
        ...
        <View style={{paddingHorizontal:'5%'}}>
            ...
            <Image source={require('../../assets/images/next.png')} resizeMode="contain" style={{height:15,width:10}}/>
            </View>
    ...
    width:'48%',marginRight:10,alignItems:'center'}}>
        ...
        <View style={[styles.upcomingList,{paddingBottom:'25%'}]}>
                        <View style={{}}>
